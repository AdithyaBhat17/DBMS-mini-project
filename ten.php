...
<body class="background">
	...
	<div id="aa" style="white-space:nowrap">
      ...
      <div id="texts"  style="position:relative; top:25px;display:inline; float:right; font-size:23px">PRICE RANGE-
 ...
 ?>
    ...
    <?php $img='<img src="x31_.png" width="19.2%" height="50%">';
          $img2='<div style="position:relative;float:left;width:19.2%; height:50%; margin-bottom:25px; margin-right:60px; font-size:90%; text-align:center;box-sizing:border-box;"><img src="x31_.png" alt="picture"   />';
          $img3='</div>';
    ?>
   ...
   <?php
      ...
      while($start <= $end) {
          ...
          echo '<input id="' .$btn. '" type="submit" class = "form1" name="' .$btn. '" value="' . $mod . '" style="position:absolute;top: 285px;left: 72px;text-align:center;z-index: 10000000; color:white;max-width: 150px;min-width:150px;margin: 0 auto 100px;padding: 3px;text-align: center;background:#46A240;">';
