...
?>
      ...
      <div id="texts" style="display:inline;position:relative;top:-15;left:350; font-size:18px">User : <?php echo $_SESSION['user_name'];?></div>
      <a id="texts" style="display:inline;position:relative;top:-15;left:400;font-size:18px" href="first.php">LOGOUT</a>
    </div>
